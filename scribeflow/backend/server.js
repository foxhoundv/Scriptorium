...
app.get('/api/health', async (req, res) => {
  try {
    ...
    res.json({ status: 'ok', version: '1.2.0', name: 'ScribeFlow', projects: files.length, dataDir: DATA_DIR });
  } catch {
    res.json({ status: 'ok', version: '1.2.0', name: 'ScribeFlow', projects: 0, dataDir: DATA_DIR });
  }
});
